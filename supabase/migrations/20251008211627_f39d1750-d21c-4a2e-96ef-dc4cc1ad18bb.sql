...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'images' AND policyname = 'Users can view own images') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'images' AND policyname = 'Users can insert own images') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'images' AND policyname = 'Users can update own images') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'images' AND policyname = 'Users can delete own images') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'samples' AND policyname = 'Users can view own samples') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'samples' AND policyname = 'Users can insert own samples') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'samples' AND policyname = 'Users can update own samples') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'samples' AND policyname = 'Users can delete own samples') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'validate_astria_integration') THEN
        -- Create a validation function to ensure all components are ready
        CREATE FUNCTION public.validate_astria_integration()
        RETURNS TEXT
        LANGUAGE plpgsql
        SECURITY DEFINER
